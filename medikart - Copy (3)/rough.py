...
#     try:
#         interval = int(request.form.get('schedule_interval', 0))  # Default to 0 (none)
#         cart = carts_collection.find_one({'username': session['username']})
...
#         # Generate user-friendly interval message
#         if interval == 1:
#             interval_display = "1 minute"
#         elif interval == 21600:
#             interval_display = "15 days"
#         elif interval == 43200:
#             interval_display = "30 days"
#         elif interval == 64800:
#             interval_display = "45 days"
#         else:
...
# #     scheduler_running = any(job.id == 'process_scheduled_orders' for job in existing_jobs)
    
# #     return render_template('order_history.html', 
# #                          orders=orders,
# #                          scheduler_running=scheduler_running)  # Pass status to template
# @app.route('/orders')
# def view_orders():
#     if 'username' not in session:
#         flash("Please log in to view your orders.", "error")
